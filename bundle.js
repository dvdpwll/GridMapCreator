...
/***/ function(module, exports, __webpack_require__) {
	...
	var grassImg = '<img data-thing="grass" src="./assets/grass.png">'; //change this if you change the img file for grass.
	var rockImg = '<img data-thing="rock" src="./assets/rock.png">'; //change this if you change the img file for rock.
	var rocksImg = '<img data-thing="rocks" src="./assets/rocks.png">'; //change this if you change the img file for rocks.
	var treeImg = '<img data-thing="tree" src="./assets/tree.png">'; //change this if you change the img file for tree.
	var treesImg = '<img data-thing="trees" src="./assets/trees.png">'; //change this if you change the img file for trees.
	var waterImg = '<img data-thing="water" src="./assets/water.png">'; //change this if you change the img file for water.
	var water2Img = '<img data-thing="water2" src="./assets/water2.png">'; //change this if you change the img file for water2.
	...
	var newElements = function newElements(data) {
	  ...
	  $('.square').each(function () {
	    ...
	    api.newElement(data).done(ui.newElementSuccess).fail(ui.failure);
	  });
	};
	...
	//send save data
	var sendSave = function sendSave(t, id, i) {
	  //put info in data object
	  var data = {
	    "element": {
	      "thing": t
	  ...
	  api.saveElement(data, id).done(ui.saveElementsSuccess(i)).fail(ui.failure);
	};
	...
	var onSaveMap = function onSaveMap() {
	  ...
	  $('.square').each(function () {
	    ...
	    //get id of element
	    var id = api.appVar.app.elements[order];

	    //extracts the data-thing value from the img
	    var thing = $(this).children().data('thing');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newElementSuccess = function newElementSuccess(data) {
	  //get order number
	...
	var saveElementsSuccess = function saveElementsSuccess(i) {
	  var last = appVar.app.elements.length;
	  if (i === --last) {
	...
	module.exports = {
	  ...
	  newElementSuccess: newElementSuccess,
